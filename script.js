...
class Firework {
    // 烟花构造函数
    constructor(x, y, color, riseSpeed = -1, particleSize = 0.5) {
        this.x = x; // 烟花的x坐标
        this.y = y; // 烟花的y坐标
...
for (let i = 0; i < particleCount; i++) {
    ...
    // 创建新粒子并添加到粒子数组中
    this.particles.push(new Particle(this.x, this.y, this.particleSize, 'rgb(255, 230, 159)', {
...
function createFirework() {
    ...
    const color = 'rgb(255, 230, 159)';// 随机选择颜色
